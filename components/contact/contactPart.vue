  ...
  <section class="contact">
    <div class="columns">
      ...
      <div class="column is-one-fourth">
        <div class="smaller dark">
          <h2>
            Business Name
            <hr>
          </h2>
          Street
          <br> City, Code, Country
        </div>
      </div>
      <div class="column is-one-fourth dark">
        <div class="smaller">
          <p>
            <a href="mailto:hello@something.something">
    ...
    <div class="columns">
      ...
      <div class="column is-one-fourth">
        <iframe width="425" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.openstreetmap.org/export/embed.html?bbox=6.845630407333375%2C52.23182602420405%2C6.850887537002564%2C52.23386629434296&amp;layer=mapnik&amp;marker=52.23284617099531%2C6.848258972167969"
          style="border: 1px solid black"></iframe>
        <br/>
        <small>
          <a href="https://www.openstreetmap.org/?mlat=52.23285&amp;mlon=6.84826#map=19/52.23285/6.84826">View Larger Map</a>
        </small>
      </div>
      <div class="column auto">
      </div>
